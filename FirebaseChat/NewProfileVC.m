...
@interface NewProfileVC () <UITableViewDelegate, UITableViewDataSource,UIImagePickerControllerDelegate,UINavigationControllerDelegate,UITextFieldDelegate,GIDSignInDelegate,GIDSignInUIDelegate,UIPickerViewDataSource, UIPickerViewDelegate>
